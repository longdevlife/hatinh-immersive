...
export default defineConfig({
  testDir: './e2e',
  testIgnore:
    /(?:explore-map-real|immersive-(minimap|production|parity)|selected-3d(?:-(?:local-anchors|public-runtime))?|navigation-return-context|panorama-tour|reference-parity-immersive)\.spec\.ts/,
  fullyParallel: true,
