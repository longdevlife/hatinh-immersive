...
export default defineConfig({
  testDir: './e2e',
  testIgnore:
    /(?:explore-map-real|explore-map-hybrid-controls|immersive-(minimap|production|parity)|selected-3d(?:-(?:local-anchors|public-runtime))?|navigation-return-context|panorama-tour|reference-parity-(?:immersive|real-psv))\.spec\.ts/,
  fullyParallel: true,
